...
let inner = {"handle1": "", "handle2": "", "handle3": '', "remote": ''};
...
function popup(type){
	...
	document.querySelector("#tvbaskethandle1").addEventListener("click", function(){popup("handle1");});
	document.querySelector("#tvbaskethandle2").addEventListener("click", function(){popup("handle2")});
	document.querySelector("#tvbaskethandle3").addEventListener("click", function(){popup("handle3")});
	document.querySelector(".remote").addEventListener("click", function(){popup("remote")});
}
